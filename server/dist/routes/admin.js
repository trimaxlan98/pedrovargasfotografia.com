...
const notifications = __importStar(require("../controllers/notificationController"));
...
router.post('/invitations/:id/music', upload_1.uploadAudio.single('audio'), admin.addInvitationMusic);
