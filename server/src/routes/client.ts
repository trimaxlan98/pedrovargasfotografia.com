...
router.delete('/invitations/:id/photos/:index', client.deleteInvitationPhoto)
router.post('/invitations/:id/custom-template', uploadImage.single('template'), client.uploadCustomTemplate)
router.post('/invitations/:id/custom-template-pages', uploadImage.array('pages', 4), client.uploadCustomTemplatePages)
router.post('/invitations/:id/music', uploadAudio.single('audio'), client.addInvitationMusic)
router.post('/stickers/upload', uploadImage.single('sticker'), client.uploadCustomSticker)
