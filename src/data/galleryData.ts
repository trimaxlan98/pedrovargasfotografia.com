...
export const profilePhotos = {
  hero: {
    src: heroPedro,
    alt: 'Retrato del fotografo Pedro Vargas',
    position: '50% 20%',
  },
  about: {
    src: aboutPedro,
    alt: 'Pedro Vargas sentado con su camara en estudio',
    position: '50% 34%',
  },
}
...
export const portfolioPhotos: PortfolioPhoto[] = [
  {
    id: 1,
    title: 'Sesion preboda en campo',
    type: 'Bodas',
    filters: ['Sesiones', 'Bodas'],
    aspect: 'landscape',
    src: portfolioBodasSesionCampo,
    alt: 'Pareja corriendo en una sesion de boda al aire libre',
    position: '50% 48%',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: 'Retrato quinceanera en jardin',
    type: 'Quince Años',
    filters: ['Sesiones', 'Quince Años'],
    aspect: 'portrait',
    src: portfolioXvRetratoJardin,
    alt: 'Retrato de quinceanera en jardin',
    position: '50% 28%',
  },
  {
    id: 4,
    ...
    aspect: 'portrait',
    src: portfolioXvRamo,
    alt: 'Quinceanera con ramo rojo en retrato vertical',
    position: '50% 30%',
  },
  {
    id: 5,
    title: 'Beso en camioneta clasica',
    type: 'Bodas',
    filters: ['Sesiones', 'Bodas'],
    aspect: 'portrait',
    src: portfolioBodaCamioneta,
    alt: 'Pareja besandose en camioneta clasica',
    position: '40% 52%',
  },
  {
    id: 6,
    title: 'Sesion en fuente monumental',
    type: 'Bodas',
    filters: ['Sesiones', 'Bodas'],
    aspect: 'landscape',
  ...
  },
  {
    ...
    alt: 'Quinceanera en vestido negro en interior de piedra',
    position: '50% 48%',
  },
  {
    id: 8,
    ...
    alt: 'Ceremonia de quince anos en iglesia',
    position: '50% 50%',
  },
  {
    id: 9,
  ...
  },
  {
    ...
    alt: 'Quinceanera con vestido rojo en hacienda',
    position: '50% 42%',
  },
  {
    id: 12,
    ...
    alt: 'Detalle del novio alistandose antes de la boda',
    position: '50% 35%',
  },
]
...
export const eventsData: EventCard[] = [
  {
    ...
    venue: 'Salon de Eventos',
    type: 'Bodas',
    description: 'Cobertura de alto dinamismo en pista, con luz de escenario y enfoque en expresion.',
  ...
  },
  {
    ...
    venue: 'Jardin Privado',
    type: 'Bodas',
    description: 'Fotografia documental enfocada en abrazos y reacciones autenticas de familia cercana.',
  ...
  {
    year: '2024',
    title: 'Diseno y Detalle',
    venue: 'Recepcion Nocturna',
    type: 'Bodas',
    description: 'Captura editorial de decoracion, mesa y ambientacion para narrar el evento completo.',
  ...
  },
  {
    year: '2025',
    title: 'Vals Familiar',
    venue: 'Salon Versalles',
    type: 'Quince Años',
    description: 'Secuencia del primer baile con enfoque en movimiento, vestuario y conexion familiar.',
    src: eventXvBaileFamiliar,
    alt: 'Baile de quinceanera con familiar en pista',
    position: '50% 50%',
  },
  {
    year: '2024',
    title: 'Escenografia de Salon',
    venue: 'Evento Tematico',
    type: 'Quince Años',
    description: 'Composicion amplia para mostrar arquitectura del lugar, color y montaje principal.',
    src: eventXvSalon,
    alt: 'Quinceanera en salon decorado con telas rojas',
    position: '50% 43%',
  },
  {
    year: '2024',
    title: 'Backstage de Preparacion',
    venue: 'Casa de la Festejada',
    type: 'Quince Años',
    description: 'Registro previo a ceremonia: maquillaje, estilismo y retratos espontaneos.',
    src: eventXvPreparativos,
    alt: 'Quinceanera en preparativos con estilista',
    position: '52% 40%',
  },
]
